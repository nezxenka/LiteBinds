...
public class ExplosiveHandler extends HolyLiteItemHandler implements ActionHandler {

    @Override
    public void handle(ActionContext context) {
        ItemStack itemStack = findItemInInventory(context.getPlayer(), "explosive_stuff");
        if (itemStack == null) {
            return;
        }
