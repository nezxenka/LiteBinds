...
public class AlternativeTrapHandler extends HolyLiteItemHandler implements ActionHandler {

    @Override
    public void handle(ActionContext context) {
        ItemStack itemStack = findItemInInventory(context.getPlayer(), "alternative_trap");
        if (itemStack == null) {
            return;
        }
